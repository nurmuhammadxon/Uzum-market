...
function addProduct(product__list, product__item) {
...
let product__lists = document.querySelectorAll('.product__list')

product__lists.forEach((product__list) => {
    popular__product__data.forEach((product__item) => {
        addProduct(product__list, product__item)
    })
})
